...
// Post meta descirption get from here.
    function web_development_entry_meta()
    {
        ...
        $web_development_date = sprintf(
            '<span><i class="mrd fa fa-clock-o"></i> <a href="%1$s" title="%2$s" ><time datetime="%3$s">%4$s</time></a></span>',
        ...
        $web_development_author = sprintf(
            '<span><i class="mrd fa fa-user"></i> <a href="%1$s" title="%2$s" >%3$s</a></span>',
